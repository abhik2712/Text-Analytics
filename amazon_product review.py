...
train_file = bz2.BZ2File('/Users/abhiknaskar/Desktop/Amazon Datasets/train.ft.txt.bz2')
test_file = bz2.BZ2File('/Users/abhiknaskar/Desktop/Amazon Datasets/test.ft.txt.bz2')
...
reviews_train, y_train = splitReviewsLabels(train_file_lines)
reviews_test, y_test = splitReviewsLabels(test_file_lines)
